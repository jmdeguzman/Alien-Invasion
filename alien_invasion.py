...
from GamesStats import GamesStats
...
class AlienInvasion:
    ...
    def _start_game(self):
        ...
        # get rid of any remaining aliens and bukets
        self.aliens.empty()
        self.bullets.empty()
    ...
    def _fire_bullet(self):
        """Create a new bullt and add it to the bullets group"""
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # create a new fleet if the fleet is destroyed
        if not self.aliens:
            self.bullets.empty()
            self._create_fleet()
